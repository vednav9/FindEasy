...
class _BookingDetailScreenState extends State<BookingDetailScreen> {
  late DocumentSnapshot _bookingDoc;
  ...
  Future<void> _rescheduleBooking() async {
    ...
    if (fcmToken != null && fcmToken.isNotEmpty) {
      await service.sendNotification(
        ...
        body:
            'Customer ${bookingData['customerName']} rescheduled the booking to $formattedDate at $formattedTime',
      );
    }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildSectionCard("Provider", data['providerName']),
            ...
            if (!isCancelled && (status == 'pending' || status == 'confirmed'))
